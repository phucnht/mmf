      ...
      <Container className="2xl:max-w-[132rem]">
        ...
        <Box className="relative h-[86rem] w-full rounded-[2rem] border-[3px] border-green-200">
          ...
          <Flex className="relative p-24 flex-col gap-16 items-center z-10">
            ...
            <Grid className="grid-cols-2 w-full p-8 gap-10">
              <Flex className="flex-col items-center w-full">
                <Image alt="Buy Box" src={imgDashboardBox} />
              </Flex>
              <Flex className="flex-col justify-between gap-9">
                <Flex className="flex-col mt-9 text-white gap-4">
                  ...
                  <Button color="secondary" className="text-red-100 p-8 w-fit text-xl" content="Purchase 500 BNB" />
                </Flex>
              </Flex>
            </Grid>
          </Flex>
